...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/fernandosanchezjr/btcutil/txsort)
...
```bash
$ go get -u github.com/fernandosanchezjr/btcutil/txsort
```
